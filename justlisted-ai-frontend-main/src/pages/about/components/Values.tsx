  ...
  return (
    <div className="values">
      <div className="container">
        ...
        <p>
          In embodying these values, JustListed AI not only provides a service
          but also fosters a community of real estate professionals who are
          equipped, empowered, and inspired to excel in their field. Our mission
          and values are the guiding principles that shape our actions, our
          platform, and our commitment to revolutionizing the real estate
          industry.
        </p>
      </div>
    </div>
